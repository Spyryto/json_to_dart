...
void main() async {
  ...
  test('generated code should have nullable type hints', () {
    expect(dartCode.code.contains('Dati dati;'), equals(false));
    expect(dartCode.code.contains('Dati? dati;'), equals(true));
  });
}
